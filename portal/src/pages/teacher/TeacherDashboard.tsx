      ...
      <div className="relative flex flex-col min-h-screen">
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2 relative z-10">
          ...
          <div className="flex items-center gap-2.5">
            <div style={{ width: 36, height: 36, borderRadius: '50%', background: 'rgba(255,255,255,.65)', border: '1px solid rgba(255,255,255,.6)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
