      ...
      <div className="relative flex flex-col min-h-screen">
        ...
        <div className="flex items-center justify-between px-4 pt-4 pb-2 relative z-10">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center justify-center relative" style={{ width: 32, height: 32, borderRadius: '50%', background: 'rgba(255,255,255,.65)', border: '1px solid rgba(255,255,255,.6)', backdropFilter: 'blur(10px)', marginLeft: 2 }}>
              <Icon name="bell" size={16} color={BB.ink} />
              <div className="absolute" style={{ top: 7, right: 7, width: 7, height: 7, borderRadius: '50%', background: BB.coral, border: '2px solid #fff' }} />
            </div>
            <button onClick={() => { logout(); navigate(R.LOGIN) }} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
              <Avatar name={user?.name ?? ''} color={BB.coral} size={32} />
            </button>
          </div>
        </div>
